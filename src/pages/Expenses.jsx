...
import {
  Plus, Search, Wallet, TrendingDown, Calendar, Edit, Receipt, Filter, Tag
} from "lucide-react";
          ...
          {filtered.map(expense => (
            <Card key={expense.id} className="p-4 hover:shadow-md transition-all hover:-translate-y-0.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      <span className="text-xs text-muted-foreground">
                        📅 {expense.expense_date ? isValid(new Date(expense.expense_date)) ? format(new Date(expense.expense_date), 'yyyy/MM/dd') : '' : ''}
                      </span>
              ...
              <div className="flex items-center gap-2 pt-3 border-t border-border">
                ...
                <ActionButtons entityName="Expense" record={expense} onDeleted={loadData} size="sm" />
              </div>
            </Card>
          ))}
        </div>
