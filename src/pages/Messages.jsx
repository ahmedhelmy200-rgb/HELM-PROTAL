                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {conv.last_message_date && (
                            <span className="text-[10px] text-muted-foreground shrink-0 ml-2">
                              {( ()=>{ try{ const d=new Date(conv.last_message_date); return isValid(d)?format(d,'MMM d'):''}catch{return ''}})()}
                            </span>
                          )}
                        </div>
                        {conv.last_message && (
                      ...
                      <div key={msg.id} className={cn("flex", isMe ? "justify-end" : "justify-start")}>
                        ...
                        >
                          ...
                          <p className={cn(
                            ...
                            {( ()=>{ try{ const d=new Date(msg.created_date); return isValid(d)?format(d,'h:mm a'):''}catch{return ''}})()}
                          </p>
                        </div>
                      </div>
                    );
