...
export default function Settings() {
  ...
  const handleUpload = async (field) => {
    ...
    input.onchange = async (e) => {
      ...
      setSettings(s => ({ ...s, [`${field}_url`]: preview_url || file_url, [`${field}_url_ref`]: storage_ref || file_url }));
                ...
                <div dir="rtl" className="border-2 rounded-xl p-6 bg-white shadow-inner" style={{ borderColor: settings.primary_color || "#1d4ed8" }}>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 mr-4">
                      {settings.stamp_url && <img src={settings.stamp_url} alt="stamp" className="h-14 w-14 object-contain opacity-80" />}
                      {settings.signature_url && <img src={settings.signature_url} alt="sig" className="h-10 object-contain" />}
                    </div>
                  </div>
                </div>
              </CardContent>
