...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className={cn("min-h-screen flex app-shell") } dir="rtl">
      ...
      <aside className="hidden md:flex flex-col w-64 sidebar-shell min-h-screen fixed right-0 top-0 z-40" onWheelCapture={(event) => handleSidebarWheel(event, desktopSidebarScrollRef)}>
